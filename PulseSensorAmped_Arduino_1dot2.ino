...
int blinkPin_high = 11;                // pin to blink led at each beat
int blinkPin_mid = 10;
int blinkPin_low = 9;
int fadePin = 5;                  // pin to do fancy classy fading blink at each beat
int fadeRate = 6;                 // used to fade LED on with PWM on fadePin
...
void setup(){
  pinMode(blinkPin_high,OUTPUT);         // pin that will blink to your heartbeat!
